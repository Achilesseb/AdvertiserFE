...
const LoginPage = () => {
  ...
  return (
    <div className=" h-fulloverflow-hidden flex flex-col items-center justify-center">
      <div className="text-center mt-2">
        ...
        <h2 className="text-4xl tracking-tight">Log in into your account</h2>
            ...
            <div className="w-full flex items-center justify-between  mb-4 ">
              ...
              >
                {/* <input
                  ...
                  name=""
                  id=""
                  className="h-full mx-4 w-4 bg-white shadow "
                />
                <span className="text-sm text-gray-700 pt-1 align-middle">
                  Remember Me
                </span> */}
              </label>
